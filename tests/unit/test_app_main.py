...
class AppMainTests(unittest.TestCase):
    ...
    def testLegacyPackagedExecutableDefaultCommandStillStartsTray(self) -> None:
        with patch("sys.executable", "C:\\Program Files\\CartridgeLauncher\\CartridgeLauncher.exe"):
            self.assertEqual(defaultCommand(), "tray")
